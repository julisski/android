...
// Theme.kt
//
// Defines AppReleaseBasicsTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.appreleasebasics.ui.theme
...
/**
 * AppReleaseBasicsTheme — wrap the app's content in this to apply the design system.
 *
