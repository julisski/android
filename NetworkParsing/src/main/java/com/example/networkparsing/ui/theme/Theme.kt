...
// Theme.kt
//
// Defines NetworkParsingTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.networkparsing.ui.theme
...
/**
 * NetworkParsingTheme — wrap the app's content in this to apply the design system.
 *
