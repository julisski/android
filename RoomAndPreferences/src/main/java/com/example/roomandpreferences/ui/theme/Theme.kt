...
// Theme.kt
//
// Defines RoomAndPreferencesTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.roomandpreferences.ui.theme
...
/**
 * RoomAndPreferencesTheme — wrap the app's content in this to apply the design system.
 *
