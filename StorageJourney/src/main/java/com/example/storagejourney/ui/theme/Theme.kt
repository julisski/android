...
// Theme.kt
//
// Defines StorageJourneyTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.storagejourney.ui.theme
...
/**
 * StorageJourneyTheme — wrap the app's content in this to apply the design system.
 *
