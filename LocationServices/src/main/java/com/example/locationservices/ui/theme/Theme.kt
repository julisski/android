...
// Theme.kt
//
// Defines LocationServicesTheme — the single Composable that wraps the whole app
// UI and supplies the Material 3 design system (color scheme + typography). On
// Android 12+ it can use wallpaper-based dynamic color; otherwise it falls back
// to the static light/dark palettes from Color.kt.
// =============================================================================
...
/**
 * LocationServicesTheme — wrap the app's content in this to apply the design system.
 *
