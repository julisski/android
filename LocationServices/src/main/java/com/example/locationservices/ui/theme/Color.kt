...
// Color constants — Theme.kt maps them onto Material "roles" (primary, etc.)
// for light and dark. "80" tones are light/pastel (used in the DARK theme);
// "40" tones are deeper/saturated (used in the LIGHT theme).
// =============================================================================
