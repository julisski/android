...
// Theme.kt
//
// Defines NavOverlayTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navoverlay.ui.theme
...
/**
 * NavOverlayTheme — wrap the app's content in this to apply the design system.
 *
