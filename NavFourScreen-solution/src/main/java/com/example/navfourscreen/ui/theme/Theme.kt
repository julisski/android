...
// Theme.kt
//
// Defines NavFourScreenTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navfourscreen.ui.theme
...
/**
 * NavFourScreenTheme — wrap the app's content in this to apply the design system.
 *
