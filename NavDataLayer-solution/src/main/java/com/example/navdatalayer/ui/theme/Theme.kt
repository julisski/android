...
// Theme.kt
//
// Defines NavDataLayerTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navdatalayer.ui.theme
...
/**
 * NavDataLayerTheme — wrap the app's content in this to apply the design system.
 *
