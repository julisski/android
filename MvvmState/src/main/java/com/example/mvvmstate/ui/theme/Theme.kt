...
// Theme.kt
//
// Defines MvvmStateTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.mvvmstate.ui.theme
...
/**
 * MvvmStateTheme — wrap the app's content in this to apply the design system.
 *
