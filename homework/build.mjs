...
function overviewPanel() {
  ...
  <section class="panel" id="p-overview" role="tabpanel" aria-labelledby="t-overview">
    ...
    <p style="font-size:13px;color:var(--muted);margin:0;"><b>See it live:</b> the <a href="./playground.html">Compose Playground</a> (root-layout dropdown + the "Choosing a container" reference cards) and the <b>Layouts</b> tab in the <b>ComposeParts</b> app both let you flip between these and watch the result change.</p>
