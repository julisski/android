...
// Theme.kt
//
// Defines ExampleProjectTheme — the single Composable that wraps the entire app
...
/**
 * ExampleProjectTheme — wrap the app's content in this to apply the design system.
 *
