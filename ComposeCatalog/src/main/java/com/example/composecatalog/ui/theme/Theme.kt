...
// Theme.kt
//
// Defines ComposeCatalogTheme — the single Composable that wraps the entire app
...
/**
 * ComposeCatalogTheme — wrap the app's content in this to apply the design system.
 *
